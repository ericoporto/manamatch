...
import void StopTweenPosition(static Piece, PieceID id);
import void StopTweenTransparency(static Piece, PieceID id);
import void StopTweenScale(static Piece, PieceID id);
import void StopTweenAll(static Piece, PieceID id);